...
from rod.common.factories import RandomModelFactory
from rod.common.factories import SimpleModelFactory
from rod.common.models import TimestampsOpinionated
...
def test_if_model_update_does_not_update_updated_at_when_auto_updated_at_false():
    ...
    with patch("rod.common.services.timezone.now") as now:
        updated_instance, has_updated = model_update(
            instance=instance,
            fields=["created_at"],
            data=data,
